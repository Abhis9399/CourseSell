...
function footer(){
    ...
    <ul className="social-icon">
      <li className="social-icon__item"><a className="social-icon__link" href="">
          <img  style={{width:'100px'}} className="social_img" src="./images/facebook1.png"  alt="www.facebook.com/abhishek_dahiwal_07"/>
        </a></li>
      <li className="social-icon__item"><a className="social-icon__link" href="#">
      <img style={{width:'100px'}} className="social_img"  src="./images/linkedin1.png"  alt="www.linkedin.com/in/abhishek-dahiwal-0bb557224"/>
        </a></li>
